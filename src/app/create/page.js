                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <input 
                        ...
                        className="w-full p-4 bg-white rounded-xl border-2 border-pink-100 focus:border-red-400 focus:ring-4 focus:ring-red-100 transition outline-none font-bold text-gray-900 placeholder-black-400 text-lg shadow-sm" 
            ...
            {step === 2 && (
              <motion.div key="step2" variants={slideVariants} initial="hidden" animate="visible" exit="exit" className="flex-1 flex flex-col">
                ...
                <textarea 
                    ...
                    className="flex-1 w-full p-5 bg-white rounded-xl border-2 border-pink-100 focus:border-red-400 focus:ring-4 focus:ring-red-100 transition outline-none resize-none font-medium text-gray-800 text-lg leading-relaxed shadow-sm placeholder-gray-400" 
                    placeholder="My Dear Valentine..."
                ></textarea>
